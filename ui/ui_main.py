...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.edt.setMinimumSize(QtCore.QSize(140, 25))
        self.edt.setObjectName("edt")
        self.horizontalLayout.addWidget(self.edt)
        ...
        self.twData = QtWidgets.QTableWidget(self.centralwidget)
        self.twData.setObjectName("twData")
        self.twData.setColumnCount(0)
        self.twData.setRowCount(0)
        self.verticalLayout.addWidget(self.twData)
